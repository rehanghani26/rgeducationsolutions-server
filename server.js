...
app.get('/api/health', (req, res) => {
  ...
  return res.json({
    ...
    database: dbStatus.isConnected ? 'MongoDB Connected' : 'Fallback Engine (Active JSON File)',
    dbDetail: dbStatus
  });
});
...
// Start listening
app.listen(PORT, () => {
  console.log(`🚀 Aegis Server running on port ${PORT} in ${process.env.NODE_ENV || 'development'} mode`);
});
