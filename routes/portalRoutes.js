...
const getPortalSettings = async () => {
  if (checkFallback()) {
    ...
    return raw?.portalSettings || {
      enabled: true,
      schoolName: raw?.schoolName || 'Apex International Academy',
      ...
      heroSubtitle: 'Nurturing young minds towards excellence, character, and lifelong curiosity in a world-class environment.',
      admissionBadge: 'Admissions Open for 2026-2027',
      aboutTitle: 'About Our School',
      aboutDescription: 'Our school provides quality education in a safe and friendly environment with experienced teachers and modern learning facilities.',
      ...
      contact: {
        address: raw?.addressLine1 || '124 Academic Enclave, Knowledge Park, City Center',
        phone: raw?.schoolPhone || '+1 (555) 234-5678',
        email: raw?.contactEmail || 'admissions@apexschool.edu',
  ...
  return {
    ...
    schoolName: ps.schoolName || settings.schoolName || 'Apex International Academy',
    schoolLogo: settings.companyLogo || settings.schoolLogo || '',
    affiliation: ps.affiliation || 'Affiliated to Central Board & Cambridge Curriculum',
    affiliationCode: ps.affiliationCode || 'SCH-2026-CBSE-9912',
    tagline: ps.tagline || 'Quality Education for a Better Future',
    heroImage: ps.heroImage || 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=1600&auto=format&fit=crop',
    heroSubtitle: ps.heroSubtitle || 'Nurturing young minds towards excellence, character, and lifelong curiosity in a world-class environment.',
    admissionBadge: ps.admissionBadge || 'Admissions Open for 2026-2027',
    aboutTitle: ps.aboutTitle || 'About Our School',
    aboutDescription: ps.aboutDescription || 'Our school provides quality education in a safe and friendly environment with experienced teachers and modern learning facilities.',
    principalName: ps.principalName || 'Dr. Eleanor Vance, Ph.D.',
    principalRole: ps.principalRole || 'Principal & Head of School',
    ...
    contact: {
      address: ps.contact?.address || settings.addressLine1 || '124 Academic Enclave, Knowledge Park, City Center',
      phone: ps.contact?.phone || settings.schoolPhone || '+1 (555) 234-5678',
      email: ps.contact?.email || settings.contactEmail || 'admissions@apexschool.edu',
      timing: ps.contact?.timing || 'Monday – Friday: 08:00 AM – 03:30 PM | Saturday: 08:30 AM – 12:30 PM',
    },
  };
};
